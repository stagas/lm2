...
function visitEuclid(src: string, program: Program): EuclidRef[] {
  void src
  const refs: EuclidRef[] = []
...
export function extractEuclidsFromProgramWithRefs(src: string, program: Program): EuclidRef[] {
  return visitEuclid(src, program)
}
