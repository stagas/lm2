import { HeartIcon, ChatIcon, RepeatIcon, ArrowLeftIcon, PlayIcon, StopIcon } from '@phosphor-icons/react'
                ...
                <div className="flex flex-row items-center gap-4">
                  ...
                  <div className="flex flex-col gap-2 flex-1 min-w-0">
                    ...
                    <div className="flex flex-row items-center gap-4 text-sm text-neutral-400">
                      <button
                        className={`flex flex-row items-center gap-1 ${canLike ? 'hover:text-white cursor-pointer' : 'cursor-default'}`}
                        onClick={e => {
                          e.preventDefault()
                  ...
                  <div className="flex flex-col gap-4">
                    {(cachedComments ?? []).length === 0 ? (
                      ...
                      (cachedComments ?? []).sort((a, b) => a.timestamp - b.timestamp).map(c => {
                        ...
                        return (
                          <div key={c.id} className="flex flex-row items-start gap-3 border-b border-neutral-800 pb-3">
                    ...
                    {userId ? (
                      ...
                      <div className="text-sm text-neutral-600 pt-4 border-t border-neutral-800">Sign in to leave a comment.</div>
                    )}
                  </div>
                )}
              </div>
