...
export function callPhasor(
  ...
  const phasor = program.gensPool.get(Op.Phasor) as Phasor
  phasor.hz$ = hz$
  phasor.trig$ = trig$
  phasor.offset$ = offset$
  phasor.process(out$, length)
